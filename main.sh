...
python code/vild_main.py --il_method infogail --env_id 21 --rl_method trpo --seed 6 --robo_task full --vild_loss_type BCE
python code/test_model.py --il_method vild --env_id 21 --robo_task full --seed 6 --rl_method trpo --vild_loss_type BCE
python code/test_model.py --il_method infogail --env_id 21 --robo_task full --seed 6 --rl_method trpo --vild_loss_type BCE
